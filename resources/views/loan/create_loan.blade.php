     ...
     <div class="row mb-2">
       ...
       <div class="col-sm-6">
         <ol class="breadcrumb float-sm-right">
           ...
           <li class="breadcrumb-item active"><a href="javascript:void(0)">Loan Management</a></li>
           <li class="breadcrumb-item active"><a href="javascript:void(0)">Create Loan Information</a></li>
         </ol>
       </div>
     </div>
   </div><!-- /.container-fluid -->
