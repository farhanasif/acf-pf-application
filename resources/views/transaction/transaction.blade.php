...
<section class="content">
    ...
    <div class="card card-secondary">
        ...
        <div class="card-footer">
            <div class="row">
                ...
                <div class="col-6">
                    <div class="row">
                        <a href="download_excel/bank_recon/Transaction-sample.xlsx" class="btn btn-outline-success">Download Sample Excel</a>
                        <button type="submit" id="#" class="btn btn-outline-success" style="margin-left:10px;" data-toggle="modal"
                            data-target="#bankUploadExcel">
                            Upload Excel
                        </button>
    
                        <button type="submit" id="addnewtransaction" class="btn btn-outline-success float-right" style="margin-left:10px;" data-toggle="modal"
        ...
        <div class="modal fade" id="bankUploadExcel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Bank Transactions Excel Upload</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
                </div>
                <form action="{{ url('/transaction-excel-upload') }}" method="post" enctype="multipart/form-data">
                   @csrf
    ...
    <div class="card card-success card-outline">
        <div class="card-header">
            ...
            <button type="button" class="btn btn-success float-right" id="bankReconciliationExcelDownload">Download Excel</button>
    ...
    <div class="card card-success card-outline">
        <div class="card-header">
            ...
            <button type="button" class="btn btn-success float-right" id="bankBookExcelDownload">Download Excel</button>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <br />
...
$(document).ready(function() {
    ...
    // START BANK BOOK TABLE DATA DOWNLOAD CLICK FUNCTION
    $( "#bankBookExcelDownload" ).click(function() {
        $("#bankbook").tableToCSV();
    });
    // END BANK BOOK TABLE DATA DOWNLOAD CLICK FUNCTION

    // START BANK RECON TABLE DATA DOWNLOAD CLICK FUNCTION
        $( "#bankReconciliationExcelDownload" ).click(function() {
        $("#bankrecon").tableToCSV();
    });
    // END BANK RECON TABLE DATA DOWNLOAD CLICK FUNCTION
