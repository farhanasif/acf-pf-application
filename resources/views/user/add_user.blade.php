           ...
           <form class="form-horizontal form-label-left" action="{{url('/save-user')}}" method="post">
             @csrf
			  ...
			  <div class="form-group row">
			   ...
			   <div class="form-group row">
			    <label for="email" class="col-form-label col-md-2 col-sm-3 label-align">Email</label>
			    <div class="col-md-6 col-sm-6 ">
			   ...
			   <div class="form-group row">
			    <label for="email" class="col-form-label col-md-2 col-sm-3 label-align">Rights Body</label>
			    <div class="col-md-6 col-sm-6 ">
