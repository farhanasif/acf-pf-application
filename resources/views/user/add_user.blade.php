...
@section('content')
 ...
 <div class="form-group row">
  ...
  <div class="col-md-6 col-sm-6 ">
     <input type="text" class="form-control" name="gross_salary" placeholder="Gross Salary">
  </div>
</div>

<div class="form-group row">
 <label for="provident_fund" class="col-form-label col-md-2 col-sm-3 label-align">Provident Fund</label>
 <div class="col-md-6 col-sm-6 ">
    <input type="text" class="form-control" name="provident_fund" placeholder="Provident Fund">
 </div>
</div>
...
<div class="form-group row">
 ...
 <div class="col-md-6 col-sm-6 ">
    <input type="text" class="form-control" name="provident_percentage" placeholder="Provident Percentage">
 </div>
</div>
