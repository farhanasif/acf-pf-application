            ...
            <form role="form">
                ...
                <div class="col-sm-6">
                    ...
                    <select class="custom-select" id="from_date">
                        <option value="2017-08-01 00:00:00">August'2017</option>
                        <option value="2017-09-01 00:00:00">September'2017</option>
                        <option value="2017-10-01 00:00:00">October'2017</option>
                ...
                <div class="col-sm-6">
                    ...
                    <select class="custom-select" id="to_date">
                        <option value="2017-08-01 23:59:59">August'2017</option>
                        <option value="2017-09-01 23:59:59">September'2017</option>
                        <option value="2017-10-01 23:59:59">October'2017</option>
