...
@section('content')
    ...
    <div class="card card-success card-outline">
        ...
        <section class="content">
            <div class="container-fluid">
                <form class="form-horizontal form-label-left" action="{{route('update.system.user',$user->id)}}" method="post">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="staff_code" id="staff_code" placeholder="Enter Staff Code" value="{{$user->staff_code}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="user_type" id="user_type" placeholder="Enter User Type" value="{{$user->user_type}}">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="rights_body" id="rights_body" placeholder="Enter Rights Body" value="{{$user->rights_body}}">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="mobile" id="mobile" placeholder="Enter Mobile" value="{{$user->mobile}}">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="designation" id="designation" placeholder="Enter Designation" value="{{$user->designation}}">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="department" id="department" placeholder="Enter department" value="{{$user->department}}">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="description" id="description" placeholder="Enter discription" value="{{$user->description}}">
