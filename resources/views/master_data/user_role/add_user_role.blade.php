...
@section('content')
   ...
   <div class="card card-success card-outline">
        ...
        <div class="card-body">
          <!-- /.card -->
            <!-- Horizontal Form -->
        <form class="form-horizontal form-label-left" action="{{route('save-user-role')}}" method="post">
             @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <textarea name="role_description" class="form-control" id="" cols="30" rows="3" placeholder="Role Description"></textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" class="form-control" name="value" placeholder="Role Value">
                </div>
             </div>
