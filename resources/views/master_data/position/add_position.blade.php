  ...
  <div class="container-fluid">
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><a href="#">Add Position</a></li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
   ...
   <div class="card card-success card-outline">
        ...
        <div class="card-body">
          <!-- /.card -->
            <!-- Horizontal Form -->
        <form class="form-horizontal form-label-left" action="{{route('save-position')}}" method="post">
             @csrf
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6 col-sm-6 ">
                ...
                <textarea name="position_description" class="form-control" id="" cols="30" rows="3" placeholder="Position Description"></textarea>
              </div>
            </div>
