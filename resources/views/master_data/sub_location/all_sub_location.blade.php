      ...
      <table id="all-sub-location" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                <a href="{{route('edit-sub-location',$sub_location->id)}}" class="btn btn-info btn-xs"><i class="fas fa-edit"></i></a>
                <a href="{{route('delete-sub-location',$sub_location->id)}}" class="btn btn-danger btn-xs"><i class="fas fa-trash-alt"></i></a>
            </td>
          </tr>
        @endforeach
      </tbody>
...
<script>
  ...
  // START SUB LOCATION TABLE DATA DOWNLOAD CLICK FUNCTION
      $( "#all-sub-location-download" ).click(function() {
          $("#all-sub-location").tableToCSV();
      });
  // END SUB LOCATION TABLE DATA DOWNLOAD CLICK FUNCTION
