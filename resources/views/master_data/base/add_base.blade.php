...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Add Base Information</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <li class="breadcrumb-item active"><a href="#">Base</a></li>
          <li class="breadcrumb-item active"><a href="#">Add Base Information</a></li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
   ...
   <div class="card card-success card-outline">
        <div class="card-header">
          <h3 class="card-title">Add Base Information</h3>
        </div>
        ...
        <div class="card-body">
          <!-- /.card -->
            <!-- Horizontal Form -->
        <form class="form-horizontal form-label-left" action="{{route('save-base')}}" method="post">
             @csrf
            <div class="form-group row">
              <label for="name" class="col-form-label col-md-3 col-sm-4 label-align">Base Name</label>
              <div class="col-md-6 col-sm-6 ">
                <input type="text" class="form-control" name="base_name" placeholder="Base Name">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6 col-sm-6 ">
                ...
                <textarea name="base_description" class="form-control" id="" cols="30" rows="3" placeholder="Base Description"></textarea>
              </div>
            </div>
