    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><a href="#">Edit Category Information</a></li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
   ...
   <div class="card card-success card-outline">
        ...
        <form class="form-horizontal form-label-left" action="{{route('update-category',$category->id)}}" method="post">
            ...
            <div class="form-group row">
              <label for="name" class="col-form-label col-md-3 col-sm-4 label-align">Category Name</label>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <a href="{{route('all-category')}}" class="btn btn-info ml-2">Back</a>
                </div>
            </div>
