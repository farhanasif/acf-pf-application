...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Add Duration Information</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
          <li class="breadcrumb-item active"><a href="#">Duration</a></li>
          <li class="breadcrumb-item active"><a href="#">Add Duration Information</a></li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
   ...
   <div class="card card-success card-outline">
        <div class="card-header">
          <h3 class="card-title">Add Duration Information</h3>
        </div>
        ...
        <div class="card-body">
          <!-- /.card -->
            <!-- Horizontal Form -->
        <form class="form-horizontal form-label-left" action="{{route('save-duration')}}" method="post">
             @csrf
            ...
            <div class="form-group row">
                ...
                <a href="{{route('all-duration')}}" type="submit" class="btn btn-info ml-3">Back</a>
                </div>
            </div>
