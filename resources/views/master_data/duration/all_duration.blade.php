  ...
  <div class="card card-success card-outline">
    <div class="card-header">
        ...
        <div class="float-right">
          <button type="submit" id="all-duration-download" class="btn btn-success">Download Excel</button>
            <a href="{{route('add-duration')}}" class="btn btn-success"><i class="fas fa-plus"></i> Add Duration</a>
        </div>
      ...
      <table id="all-duration" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{route('edit-duration',$duration->id)}}" class="btn btn-info btn-xs"><i class="fas fa-edit"></i></a>
              <a href="{{route('delete-duration',$duration->id)}}" class="btn btn-danger btn-xs"><i class="fas fa-trash-alt"></i></a>
            </td>
          </tr>
          @endforeach
...
<script>
  ...
  $( "#all-duration-download" ).click(function() {
          $("#all-duration").tableToCSV();
      });
