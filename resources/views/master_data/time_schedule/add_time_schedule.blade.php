  ...
  <div class="container-fluid">
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><a href="#">Add Time Schedule</a></li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
   ...
   <div class="card card-success card-outline">
        <div class="card-header">
          <h3 class="card-title">Add Time Schedule</h3>
        </div>
        ...
        <div class="card-body">
          <!-- /.card -->
            <!-- Horizontal Form -->
        <form class="form-horizontal form-label-left " action="{{route('save-time-schedule')}}" method="post">
             @csrf
