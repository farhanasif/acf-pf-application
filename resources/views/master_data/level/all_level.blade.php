  ...
  <div class="card card-success card-outline">
    <div class="card-header">
        ...
        <div class="float-right">
          <button type="submit" id="all-level-download" class="btn btn-success">Download Excel</button>
            <a href="{{route('add-level')}}" class="btn btn-success"><i class="fas fa-plus"></i> Add Level</a>
        </div>
...
<script>
  ...
  // START LEVEL TABLE DATA DOWNLOAD CLICK FUNCTION
    $( "#all-level-download" ).click(function() {
          $("#all-level").tableToCSV();
      });
  // END LEVEL TABLE DATA DOWNLOAD CLICK FUNCTION
