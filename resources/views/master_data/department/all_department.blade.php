  ...
  <div class="card card-success card-outline">
    <div class="card-header">
        ...
        <div class="float-right">
          <button type="submit" id="all-department-download" class="btn btn-success">Download Excel</button>
            <a href="{{route('add-department')}}" class="btn btn-success"><i class="fas fa-plus"></i> Add Department</a>
        </div>
...
<script>
  ...
  $( "#all-department-download" ).click(function() {
          $("#all-department").tableToCSV();
      });
