  ...
  <div class="card card-success card-outline">
    <div class="card-header">
        ...
        <div class="float-right">
            <button type="submit" id="all-interest-source-download" class="btn btn-success">Download Excel</button>
            <a href="{{route('add-interest-source')}}" class="btn btn-success"><i class="fas fa-plus"></i> Add Interest Source</a>
        </div>
...
<script>
  ...
  // START INTEREST SOURCE TABLE DATA DOWNLOAD CLICK FUNCTION
      $( "#all-interest-source-download" ).click(function() {
          $("#all-interest-source").tableToCSV();
      });
  // END INTEREST SOURCE TABLE DATA DOWNLOAD CLICK FUNCTION
