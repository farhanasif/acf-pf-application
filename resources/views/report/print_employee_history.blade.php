        ...
        <form>
          ...
          <div class="lik-uftcl-pdf-body">
            ...
            <div class="main-2">
              <div class="body-top">
                ...
                <div class="top-info">
                  ...
                  <img src="../images/logo/acf2acf.jpg" alt="acf" style="width: 200px;height: 100px;margin-left: auto;margin-right: auto;">
            ...
            <tbody>
              ...
              <td></td>
              <td></td>
              <td><b>{{ number_format(($data[0]->employee_contribution + $data[0]->employer_contribution + ($data[0]->employee_contribution * ($data[0]->interest_percent/100)) + ($data[0]->employer_contribution * ($data[0]->interest_percent/100))) - $data[0]->loan_amount, 2)  }}</b></td></tr>
            </tbody>
            </table>
            <div style="">
